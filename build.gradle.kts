...
dependencies {
    ...
    implementation("io.dropwizard:dropwizard-auth:5.0.0")
    implementation("io.dropwizard:dropwizard-core:5.0.0")
    implementation("io.dropwizard:dropwizard-jdbi3:5.0.0")
    ...
    testImplementation("io.dropwizard:dropwizard-testing:5.0.0")
