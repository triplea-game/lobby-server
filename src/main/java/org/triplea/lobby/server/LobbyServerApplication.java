...
import org.triplea.lobby.server.access.authentication.ApiKeyAuthenticator;
import org.triplea.lobby.server.access.authentication.AuthenticatedUser;
import org.triplea.lobby.server.access.authorization.BannedPlayerFilter;
import org.triplea.lobby.server.access.authorization.RoleAuthorizer;
import org.triplea.lobby.server.controllers.lobby.GameHostingController;
import org.triplea.lobby.server.controllers.lobby.GameListingController;
import org.triplea.lobby.server.controllers.lobby.LobbyWatcherController;
import org.triplea.lobby.server.controllers.lobby.PlayersInGameController;
import org.triplea.lobby.server.controllers.lobby.moderation.AccessLogController;
import org.triplea.lobby.server.controllers.lobby.moderation.BadWordsController;
import org.triplea.lobby.server.controllers.lobby.moderation.DisconnectUserController;
import org.triplea.lobby.server.controllers.lobby.moderation.ModeratorAuditHistoryController;
import org.triplea.lobby.server.controllers.lobby.moderation.ModeratorsController;
import org.triplea.lobby.server.controllers.lobby.moderation.MuteUserController;
import org.triplea.lobby.server.controllers.lobby.moderation.RemoteActionsController;
import org.triplea.lobby.server.controllers.lobby.moderation.UserBanController;
import org.triplea.lobby.server.controllers.lobby.moderation.UsernameBanController;
import org.triplea.lobby.server.controllers.user.account.CreateAccountController;
import org.triplea.lobby.server.controllers.user.account.ForgotPasswordController;
import org.triplea.lobby.server.controllers.user.account.LoginController;
import org.triplea.lobby.server.controllers.user.account.PlayerInfoController;
import org.triplea.lobby.server.controllers.user.account.UpdateAccountController;
 ...
 */
@Slf4j
public class LobbyServerApplication extends Application<LobbyServerConfig> {
  ...
  public static void main(final String[] args) throws Exception {
    final LobbyServerApplication application = new LobbyServerApplication();
