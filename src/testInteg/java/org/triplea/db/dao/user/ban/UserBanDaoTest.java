...
class UserBanDaoTest {
  ...
  class IsBannedByIp {
    ...
    @Test
    void isBanned() {
      assertThat(userBanDao.isBannedByIp("127.0.0.2"), is(true));
    }

    @Test
    void banExpired() {
      assertThat(userBanDao.isBannedByIp("127.0.0.3"), is(false));
    }
  }
  ...
  class BanLookups {
    ...
    void lookupBans() {
      ...
      assertThat(result.get(0).getIp(), is("127.0.0.3"));
      ...
      assertThat(result.get(1).getIp(), is("127.0.0.2"));
    ...
    void lookupBanEmptyCase() {
      ...
      final Optional<BanLookupRecord> result =
          userBanDao.lookupBan("2600:4041:5d8e:d900:a19e:b761:e274:7139", "system-id-DNE");
    ...
    void lookupBanRecordByIp() {
      final Optional<BanLookupRecord> result = userBanDao.lookupBan("127.0.0.3", "any-system-id");
      assertThat(
          result,
          isPresentAndIs(
